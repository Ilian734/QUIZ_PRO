...
<body>
    ...
    <div class="popup-info">
        <h2>C'est parti !</h2>
        <img src="./images/geo.jpg" alt="geo" width="100%">
        <p class="info">Bienvenue sur notre quiz</p>
<p class="info">Parcourez le globe avec notre quiz géographique passionnant !</p>
<p class="info">Testez vos connaissances sur les pays, les capitales et les merveilles naturelles du monde entier.</p>
<p class="info">Que les cartes se déploient, que l'aventure commence ! 🌍</p>
...
<div id="message"></div>
    ...
    <script src="/front/questions/qGeo.js"></script>
