...
<body>
    ...
    <div class="popup-info">
        <h2>C'est parti !</h2>
        <img src="./images/histoire.jpg" alt="sport" width="100%">
        <p class="info">Bienvenue sur notre quiz</p>
<p class="info">Remontez le temps avec notre quiz historique captivant !</p>
<p class="info">Testez vos connaissances sur les événements, les personnalités et les périodes marquantes de l'histoire.</p>
<p class="info">Que les chapitres s'ouvrent, que le passé se révèle ! 📜</p>
...
<div id="message"></div>
    ...
    <script src="/front/questions/qHistoire.js"></script>
